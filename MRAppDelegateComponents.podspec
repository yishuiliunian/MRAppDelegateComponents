#
# Be sure to run `pod lib lint MRAppDelegateComponents.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MRAppDelegateComponents'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MRAppDelegateComponents.'
